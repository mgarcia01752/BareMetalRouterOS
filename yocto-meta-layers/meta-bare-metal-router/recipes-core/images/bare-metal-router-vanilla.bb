...
IMAGE_INSTALL:append = "openssl openssh "
IMAGE_INSTALL:append = "iproute2 lshw iw iptables sudo util-linux usbutils usbinit pciutils ethtool "
IMAGE_INSTALL:append = "hostapd dnsmasq telnetd dhcpcd "
IMAGE_INSTALL:append = "bmros-startup bmros-profile "
